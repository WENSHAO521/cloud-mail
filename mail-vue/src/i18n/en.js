const en = {
    ...
    syncLive: 'Live',
    syncOffline: 'Offline',
    globalSearchPlaceholder: 'Search mail, authors, manuscripts, editors…',
    ctxContact: 'Contact',
    ctxOrg: 'Organization',
    ctxLastContact: 'Last contact',
    ctxManuscript: 'Manuscript ID',
    ctxRelatedJournal: 'Related journal',
    ctxSendingToday: 'Sent today',
    ctxActions: 'Quick actions',
    ctxUnlimited: 'Unlimited quota',
